...
export const clusters = [
  { id: "F", name: "눈가 건조·처짐 케어 탐색", volume: 88062, keywords: "アイクリーム(41,033), アイクリーム おすすめ(22,466)", note: "최대 수요 볼륨" },
  { id: "G", name: "눈가 안티에이징 케어 탐색", volume: 43942, keywords: "アイクリーム ランキング(11,366), キュレル アイクリーム(10,433)", note: "추천·랭킹 키워드 집중" },
  { id: "L", name: "가성비 아이크림 탐색", volume: 20294, keywords: "なめらか本舗(6,700), プチプラ アイクリーム(3,900)", note: "PB 자연 강점 구간" },
  { id: "H", name: "효과 좋고 가성비 좋은 연령맞춤 탐색", volume: 12629, keywords: "効果絶大プチプラ(3,200), 効果絶大 50代(2,133)", note: "効果絶大プチプラ 명시 수요" },
  { id: "C", name: "Y존 케어 탐색 (연관성 낮음)", volume: 26325, keywords: "デリケートゾーン 黒ずみ(23,833)", note: "직접 연관성 낮음" },
  { id: "M", name: "화장품 대분류 탐색 (연관성 낮음)", volume: 85986, keywords: "パック(60,500), パウダーファンデーション(25,466)", note: "직접 연관성 낮음" },
  { id: "B", name: "헬레나 루빈스타인 브랜드 탐색", volume: 7173, keywords: "ヘレナ ルビンスタイン(3,600)", note: "프리미엄 브랜드 탐색" },
  { id: "K", name: "링클크림 추천·효과 탐색", volume: 1876, keywords: "エリクシール 効果ない(1,260)", note: "효능 검증 니즈" },
  { id: "N", name: "눈가 처짐 케어 후기 탐색", volume: 987, keywords: "たるみ アイクリーム(553)", note: "처짐 특화 후기" },
  { id: "E", name: "Three 브랜드 탐색", volume: 1511, keywords: "threeハンドクリーム(1,360)", note: "브랜드 탐색" },
  { id: "I", name: "Est 브랜드 탐색", volume: 1338, keywords: "エスト 乳液(396)", note: "브랜드 탐색" },
  { id: "D", name: "남성 안티에이징 탐색", volume: 584, keywords: "ほうれい線消えるクリーム(143)", note: "경쟁 공백 (장기 검토)" },
  { id: "J", name: "가네보 안티에이징 탐색", volume: 75, keywords: "カネボウ アイセラム(10)", note: "브랜드 탐색" },
  { id: "A", name: "히스 코스메틱 활용법", volume: 358, keywords: "heath スキンケア(10)", note: "브랜드 탐색" },
];
...
export const ceps = [
  { id: "CEP-7", title: "눈가 처짐·탄력 저하 인식", situation: "노화 인식 시점, 연중", keyword: "目元のハリ, くぼみ目 アイクリーム", priority: 1 },
  { id: "CEP-6", title: "수면 부족 다음날 다크서클", situation: "아침, 연중", keyword: "青クマ アイクリーム", priority: 2 },
  { id: "CEP-1", title: "에어컨 건조 심화", situation: "여름 집중", keyword: "乾燥 アイクリーム", priority: 3 },
  { id: "CEP-4", title: "20대 잔주름 예방 시작", situation: "연중", keyword: "アイクリーム 20代", priority: 4 },
  { id: "CEP-5", title: "레티놀 자극 후 대체 탐색", situation: "연중", keyword: "レチノールなし アイクリーム", priority: 5 },
  { id: "CEP-3", title: "메이크업 전 들뜸 발견", situation: "아침, 연중", keyword: "アイクリーム メイク前", priority: 6 },
  { id: "CEP-9", title: "스마트폰·PC 후 저녁 다크서클", situation: "저녁, 연중", keyword: "血行促進 アイクリーム", priority: 7 },
  { id: "CEP-2", title: "메이크업 후 눈가 자극 우려", situation: "연중", keyword: "敏感肌 アイクリーム", priority: 8 },
  { id: "CEP-8", title: "눈 밑 건조·들뜸 발견", situation: "낮, 연중", keyword: "目元の乾燥 アイクリーム", priority: 9 },
  { id: "CEP-10", title: "눈가 꺼짐 발견", situation: "연중", keyword: "目のくぼみ アイクリーム", priority: 10 },
];
